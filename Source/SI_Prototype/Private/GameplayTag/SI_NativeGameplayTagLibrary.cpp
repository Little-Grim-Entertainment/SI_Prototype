...
namespace SI_NativeGameplayTagLibrary
{
	...
	// Dialogue
	UE_DEFINE_GAMEPLAY_TAG(SITag_Dialogue, "SITag.Dialogue")
	UE_DEFINE_GAMEPLAY_TAG(SITag_Dialogue_Struct, "SITag.Dialogue.Struct")
	UE_DEFINE_GAMEPLAY_TAG(SITag_Dialogue_Struct_BubbleDialogue, "SITag.Dialogue.Struct.BubbleDialogue")
