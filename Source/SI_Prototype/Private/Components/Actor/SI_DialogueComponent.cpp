...
#include "Components/Actor/SI_DialogueComponent.h"
...
USI_DialogueComponent::USI_DialogueComponent()
{
...
void USI_DialogueComponent::BeginPlay()
{
	Super::BeginPlay();
...
// Called every frame
void USI_DialogueComponent::TickComponent(float DeltaTime, ELevelTick TickType, FActorComponentTickFunction* ThisTickFunction)
{
...
void USI_DialogueComponent::StartConversation()
{
...
void USI_DialogueComponent::PlayConversation()
{
	if (ConversationData)
	{
		...
		FSI_ConversationData* ConversationRow = ConversationData->FindRow<FSI_ConversationData>(RowNameToSearch, ContextString, true);
...
void USI_DialogueComponent::StartInterrogation()
{
	if (!ConversationData || !InterrogationData) { return; }
...
void USI_DialogueComponent::PlayInterrogation()
{
	if (InterrogationData)
	{
		...
		FSI_InterrogationData* InterrogationRow = InterrogationData->FindRow<FSI_InterrogationData>(RowNameToSearch, ContextString, true);
...
void USI_DialogueComponent::DebugSimpleConversationLines(FSI_ConversationData* Conversation_Row, FString LocalDialog)
{
	if (GEngine)
	{
...
void USI_DialogueComponent::DebugMultiConversationLines(FString LocalDialog, FString LocalTagA, FString LocalTagB, FString LocalTagC, FString LocalTagD)
{
	if (GEngine)
	{
		GEngine->ClearOnScreenDebugMessages();
...
void USI_DialogueComponent::DebugMultiConversationPlayerAnswers(FSI_ConversationData* Conversation_Row)
{
...
void USI_DialogueComponent::SetConversationMultipleAnswerTags(FSI_ConversationData* Conversation_Row, FString* LocalTagA, FString* LocalTagB, FString* LocalTagC, FString* LocalTagD)
{
...
void USI_DialogueComponent::GetNewSimpleConversationLine(FSI_ConversationData* Conversation_Row)
{
...
void USI_DialogueComponent::GetNewMultiConversationLine(FSI_ConversationData* Conversation_Row)
{
	if (!Conversation_Row->TransitionOverride)
	{
		//Go to next line
...
void USI_DialogueComponent::GetMultiConversationPlayerInput()
{
	if (!bSkipAnswerSelection)
	{
		PlayerAnswer = ESI_ConversationAnswerSelection::AnswerA;

		if (PlayerAnswerChoice == "B")
		{
			PlayerAnswer = ESI_ConversationAnswerSelection::AnswerB;
		}

		else if (PlayerAnswerChoice == "C")
		{
			PlayerAnswer = ESI_ConversationAnswerSelection::AnswerC;
		}

		else if (PlayerAnswerChoice == "D")
		{
			PlayerAnswer = ESI_ConversationAnswerSelection::AnswerD;
		}
	}

}

void USI_DialogueComponent::GetFirstConversationLine()
{
	if (ConversationCount == 0)
	{
		...
		{
			TArray<FSI_ConversationData*> TempArr;
			static const FString ContextString(TEXT("ConversationDataContext"));
...
void USI_DialogueComponent::EndConversation()
{
...
void USI_DialogueComponent::DebugInterrogationLinesNoEvidence(FSI_InterrogationData* Interrogation_Row, FString LocalDialog)
{
	if (GEngine)
	{
		GEngine->ClearOnScreenDebugMessages();
...
void USI_DialogueComponent::DebugInterrogationLinesWithEvidence(FSI_InterrogationData* Interrogation_Row, FString LocalDialog)
{
	if (GEngine)
	{
		GEngine->ClearOnScreenDebugMessages();
...
void USI_DialogueComponent::AddInterrogationProgression(FSI_InterrogationData* Interrogation_Row)
{
	if (Interrogation_Row->AddProgression)
	{
		...
		if (!Interrogation_Row->Override_Text_In.IsEmpty())
		{
			...
			FSI_InterrogationData* TempInterrogationRow = InterrogationData->FindRow<FSI_InterrogationData>(FName(Interrogation_Row->Override_Text_In), TempContextString, true);
	...
	TArray<FSI_InterrogationData*> TempArr;
	static const FString TempContextString(TEXT("InterrogationDataContext"));
...
void USI_DialogueComponent::GetInterrogationLineWithEvidence(FSI_InterrogationData* Interrogation_Row)
{
...
void USI_DialogueComponent::GetNewInterrogationLine(FSI_InterrogationData* Interrogation_Row)
{
...
void USI_DialogueComponent::GetFirstInterrogationLine()
{
...
void USI_DialogueComponent::StartInterrogationNewLoop()
{
...
void USI_DialogueComponent::EndInterrogation()
{
	if (RowNameToSearch == "End")
	{
...
void USI_DialogueComponent::AddInterrogationIrritation(FSI_InterrogationData* Interrogation_Row)
{
...
void USI_DialogueComponent::UpdateInterrogationRegister(FSI_InterrogationData* Interrogation_Row)
{
...
void USI_DialogueComponent::DecodePlayerEvidenceAnswer(FString PlayerChoice)
{
...
void USI_DialogueComponent::SetPlayerAnswer(FString Answer)
{
...
void USI_DialogueComponent::SetInterrogation(bool Start)
{
