...
#include "SI_AIPerceptionStimuliSource.generated.h"
 ...
 */
UCLASS()
class SI_PROTOTYPE_API USI_AIPerceptionStimuliSource : public UAIPerceptionStimuliSourceComponent
{
	GENERATED_BODY()

public:
	USI_AIPerceptionStimuliSource(const FObjectInitializer& ObjectInitializer);
