...
namespace SI_NativeGameplayTagLibrary
{
	...
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(SITag_Input_Action_Gadget_NickOne);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(SITag_Input_Action_Gadget_NickTwo);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(SITag_Input_Action_Gadget_NickThree);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(SITag_Input_Action_Gadget_NickFour);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(SITag_Input_Action_Gadget_GizboOne);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(SITag_Input_Action_Gadget_GizboTwo);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(SITag_Input_Action_Gadget_GizboThree);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(SITag_Input_Action_Gadget_GizboFour);
