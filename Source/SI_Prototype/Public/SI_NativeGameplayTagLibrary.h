...
namespace SI_NativeGameplayTagLibrary
{
	...
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(SITag_Input_Action_Gadget_QuickbindOne);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(SITag_Input_Action_Gadget_QuickbindTwo);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(SITag_Input_Action_Gadget_QuickbindThree);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(SITag_Input_Action_Gadget_QuickbindFour);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(SITag_Input_Action_Gadget_QuickbindFive);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(SITag_Input_Action_Gadget_QuickbindSix);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(SITag_Input_Action_Gadget_QuickbindSeven);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(SITag_Input_Action_Gadget_QuickbindEight);
