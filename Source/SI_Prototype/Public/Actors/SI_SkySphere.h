...
#include "SI_SkySphere.generated.h"

class USI_GameInstance;
class ASI_SunLight;
class USI_WorldManager;
class ADirectionalLight;

UCLASS()
class SI_PROTOTYPE_API ASI_SkySphere : public AActor
{
	GENERATED_BODY()
...
public:	
	...
	UFUNCTION()
	void SetSunLightActor(ASI_SunLight* SunLightToSet);
