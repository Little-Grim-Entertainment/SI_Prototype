...
{
	UE_DEFINE_GAMEPLAY_TAG(AOSTag_Audio, "Audio")
	UE_DEFINE_GAMEPLAY_TAG(AOSTag_Audio_Music, "Audio.Music")
	UE_DEFINE_GAMEPLAY_TAG(AOSTag_Audio_Music_Pause, "Audio.Music.Pause")
	...
	UE_DEFINE_GAMEPLAY_TAG(AOSTag_UI_Menu_Interrogation, "UI.Menu.Interrogation")
	UE_DEFINE_GAMEPLAY_TAG(AOSTag_UI_Menu_Dialogue, "UI.Menu.Dialogue")
	UE_DEFINE_GAMEPLAY_TAG(AOSTag_UI_Menu_Validation, "UI.Prompt.Validation")
	...
	UE_DEFINE_GAMEPLAY_TAG(AOSTag_UI_Screen_TitleCard, "UI.Screen.TitleCard")

	UE_DEFINE_GAMEPLAY_TAG(AOSTag_UI_Prompt, "UI.Prompt")
	UE_DEFINE_GAMEPLAY_TAG(AOSTag_UI_Prompt_Interact, "UI.Prompt.Interact")
	UE_DEFINE_GAMEPLAY_TAG(AOSTag_UI_Prompt_Skip, "UI.Prompt.Skip")
}