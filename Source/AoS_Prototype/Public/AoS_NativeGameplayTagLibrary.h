...
namespace AoS_NativeGameplayTagLibrary
{
	...
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(AOSTag_Player_Mode_Menu);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(AOSTag_Player_Mode_Media);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(AOSTag_Player_Mode_Dialogue);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(AOSTag_Player_Mode_Interrogation);
	...
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(AOSTag_UI_Menu_Type)
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(AOSTag_UI_Menu_Type_Main);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(AOSTag_UI_Menu_Type_System);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(AOSTag_UI_Menu_Type_Game);
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(AOSTag_UI_Menu_Type_Vendor);

	UE_DECLARE_GAMEPLAY_TAG_EXTERN(AOSTag_Media)
	UE_DECLARE_GAMEPLAY_TAG_EXTERN(AOSTag_Media_Type)
