...
// End Cross Module References
	DEFINE_FUNCTION(ULGCsvDataProcessorFunctionLibrary::execOnSheetStructsDownloaded)
	{
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		ULGCsvDataProcessorFunctionLibrary::OnSheetStructsDownloaded(Z_Param_InCallbackInfo);
		P_NATIVE_END;
	}
	...
	DEFINE_FUNCTION(ULGCsvDataProcessorFunctionLibrary::execImportCsvFromURL)
	{
		...
		P_GET_PROPERTY(FDelegateProperty,Z_Param_InCallbackDelegate);
		P_FINISH;
		P_NATIVE_BEGIN;
		ULGCsvDataProcessorFunctionLibrary::ImportCsvFromURL(Z_Param_Out_InImportPayload,FRDTGetStringDelegate(Z_Param_InCallbackDelegate));
		P_NATIVE_END;
	}
	...
	struct Z_Construct_UFunction_ULGCsvDataProcessorFunctionLibrary_ImportCsvFromURL_Statics
	{
		struct LGCsvDataProcessorFunctionLibrary_eventImportCsvFromURL_Parms
		{
			...
			FScriptDelegate InCallbackDelegate;
		};
#if WITH_METADATA
		...
		static const UECodeGen_Private::FDelegatePropertyParams NewProp_InCallbackDelegate;
		static const UECodeGen_Private::FPropertyParamsBase* const PropPointers[];
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam Function_MetaDataParams[];
#endif
	...
	const UECodeGen_Private::FDelegatePropertyParams Z_Construct_UFunction_ULGCsvDataProcessorFunctionLibrary_ImportCsvFromURL_Statics::NewProp_InCallbackDelegate = { "InCallbackDelegate", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Delegate, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(LGCsvDataProcessorFunctionLibrary_eventImportCsvFromURL_Parms, InCallbackDelegate), Z_Construct_UDelegateFunction_RuntimeDataTable_RDTGetStringDelegate__DelegateSignature, METADATA_PARAMS(0, nullptr) }; // 3096220853
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_ULGCsvDataProcessorFunctionLibrary_ImportCsvFromURL_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_ULGCsvDataProcessorFunctionLibrary_ImportCsvFromURL_Statics::NewProp_InCallbackDelegate,
	};
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_ULGCsvDataProcessorFunctionLibrary_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_ULGCsvDataProcessorFunctionLibrary_ImportCsvFromURL, "ImportCsvFromURL" }, // 145167790
		{ &Z_Construct_UFunction_ULGCsvDataProcessorFunctionLibrary_OnSheetStructsDownloaded, "OnSheetStructsDownloaded" }, // 3286276034
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SI_Prototype_Plugins_LGPlugins_LGCsvDataProcessor_Source_LGCsvDataProcessor_Public_LGCsvDataProcessorFunctionLibrary_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ULGCsvDataProcessorFunctionLibrary, ULGCsvDataProcessorFunctionLibrary::StaticClass, TEXT("ULGCsvDataProcessorFunctionLibrary"), &Z_Registration_Info_UClass_ULGCsvDataProcessorFunctionLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ULGCsvDataProcessorFunctionLibrary), 2577670716U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SI_Prototype_Plugins_LGPlugins_LGCsvDataProcessor_Source_LGCsvDataProcessor_Public_LGCsvDataProcessorFunctionLibrary_h_594780806(TEXT("/Script/LGCsvDataProcessor"),
