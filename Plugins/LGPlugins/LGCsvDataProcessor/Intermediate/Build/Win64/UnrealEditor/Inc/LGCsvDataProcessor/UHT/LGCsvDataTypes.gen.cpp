...
template<> LGCSVDATAPROCESSOR_API UScriptStruct* StaticStruct<FLGCsvInfoImportPayload>()
{
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FLGCsvInfoImportPayload_Statics::NewProp_FolderName_MetaData[] = {
		{ "ModuleRelativePath", "Public/LGCsvDataTypes.h" },
	};
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FLGCsvInfoImportPayload_Statics::NewProp_FolderName = { "FolderName", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FLGCsvInfoImportPayload, FolderName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLGCsvInfoImportPayload_Statics::NewProp_FolderName_MetaData), Z_Construct_UScriptStruct_FLGCsvInfoImportPayload_Statics::NewProp_FolderName_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FLGCsvInfoImportPayload_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FLGCsvInfoImportPayload_Statics::NewProp_FolderName,
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SI_Prototype_Plugins_LGPlugins_LGCsvDataProcessor_Source_LGCsvDataProcessor_Public_LGCsvDataTypes_h_Statics::ScriptStructInfo[] = {
		...
		{ FLGCsvInfoImportPayload::StaticStruct, Z_Construct_UScriptStruct_FLGCsvInfoImportPayload_Statics::NewStructOps, TEXT("LGCsvInfoImportPayload"), &Z_Registration_Info_UScriptStruct_LGCsvInfoImportPayload, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLGCsvInfoImportPayload), 1187165419U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SI_Prototype_Plugins_LGPlugins_LGCsvDataProcessor_Source_LGCsvDataProcessor_Public_LGCsvDataTypes_h_3762053412(TEXT("/Script/LGCsvDataProcessor"),
		nullptr, 0,
