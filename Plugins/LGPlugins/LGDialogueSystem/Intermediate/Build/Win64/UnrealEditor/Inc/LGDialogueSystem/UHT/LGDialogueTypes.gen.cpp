...
template<> LGDIALOGUESYSTEM_API UScriptStruct* StaticStruct<FLGDialogueURL>()
{
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FLGDialogueURL_Statics::NewProp_FileName_MetaData[] = {
		{ "Category", "LGDialogueURL" },
		{ "ModuleRelativePath", "Public/LGDialogueTypes.h" },
	};
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FLGDialogueURL_Statics::NewProp_FileName = { "FileName", nullptr, (EPropertyFlags)0x0010000000000015, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FLGDialogueURL, FileName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FLGDialogueURL_Statics::NewProp_FileName_MetaData), Z_Construct_UScriptStruct_FLGDialogueURL_Statics::NewProp_FileName_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FLGDialogueURL_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FLGDialogueURL_Statics::NewProp_FileName,
...
template<> LGDIALOGUESYSTEM_API UScriptStruct* StaticStruct<FLGCharacterDialogue>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SI_Prototype_Plugins_LGPlugins_LGDialogueSystem_Source_LGDialogueSystem_Public_LGDialogueTypes_h_Statics::ScriptStructInfo[] = {
		{ FLGDialogueURL::StaticStruct, Z_Construct_UScriptStruct_FLGDialogueURL_Statics::NewStructOps, TEXT("LGDialogueURL"), &Z_Registration_Info_UScriptStruct_LGDialogueURL, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FLGDialogueURL), 2619184208U) },
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_SI_Prototype_Plugins_LGPlugins_LGDialogueSystem_Source_LGDialogueSystem_Public_LGDialogueTypes_h_3587676717(TEXT("/Script/LGDialogueSystem"),
		nullptr, 0,
